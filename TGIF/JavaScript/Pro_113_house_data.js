...
var acessAll = function(houseArray) {
...
//PARTY FILTERS
  ...
  function filterAll() {
    ...
    if (checkResult.length == 0 && checkState !== "ALL") {
      acessAll(houseArray.filter(member => member.state == checkState));
    }
    if (checkResult.length > 0 && checkState == "ALL") {
      document.getElementById("house-body").innerHTML = "";
    ...
    if (checkResult.length > 0 && checkState !== "ALL") {
      ...
      houseArray.forEach(validate => {
        if (checkResult.includes(validate.party)){
          document.getElementById("house-body").innerHTML = "";
          filteredMembers.push(validate);
          acessAll(filteredMembers.filter(member => member.state == checkState));
        }
      })
    }
  } 
